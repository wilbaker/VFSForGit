...
static bool TryReadVNodeFileFlags(vnode_t vn, vfs_context_t context, uint32_t* flags);
static inline bool FileFlagsBitIsSet(uint32_t fileFlags, uint32_t bit);
static inline bool TryGetFileIsFlaggedAsInRoot(vnode_t vnode, vfs_context_t context, bool* flaggedInRoot);
